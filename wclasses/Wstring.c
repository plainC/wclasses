...
#define M__prepend METHOD(Wstring,public,struct Wstring*,prepend,(char* str, size_t size))
...
#define M__empty METHOD(Wstring,public,int,empty)
...
#define M__length METHOD(Wstring,public,int,length)
...
#define M__append METHOD(Wstring,public,struct Wstring*,append,(char* str, size_t size))
